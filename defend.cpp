...
typedef double tile_risk_table_t[TILE_TABLE_SIZE];		//double 类型数组
...
void Calculate_risk_table(int pack_cnt, int incomplete_cnt, tile_risk_table_t& oper, int player)
{
	...
	double total_tri_p = 0.0;
	//double total_tri_p{ 0 };
	double	total_straight_p{ 0 };
	double	total_pair_p{ 0 };
	double	total_dazi_p{ 0 };
	if (1)
	{
